...
OUTPUT="$ROOT_DIR/.build/workspace-hub-create-checks"
...
swiftc \
  ...
  "$ROOT_DIR/Reopen/WorkspaceHub/WorkspaceHubCreateCoordinator.swift" \
  "$ROOT_DIR/scripts/check-workspace-hub-create.swift" \
  -o "$OUTPUT"
