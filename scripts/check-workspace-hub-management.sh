...
OUTPUT="$ROOT_DIR/.build/workspace-hub-management-checks"
...
swiftc \
  ...
  "$ROOT_DIR/Reopen/WorkspaceHub/WorkspaceHubManagementCoordinator.swift" \
  "$ROOT_DIR/scripts/check-workspace-hub-management.swift" \
  -o "$OUTPUT"
